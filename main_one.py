...
router = Router()
router.get('/one', PagesController, 'first_page')
router.get('/two', PagesController, 'second_page')
router.get('/three', PagesController, 'third_page')
router.get('/', PagesController, 'list_page')
